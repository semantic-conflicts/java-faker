...
public class Faker implements Resolver {
  ...
  public static FakeValuesServiceInterface createProxiedFakeValuesService(  FakeValuesServiceInterface fakeValuesServiceInterface,  FakeValuesServiceInterface defaultFakeValuesServiceInterface){
  ...
  /** 
 * Returns a string with the '#' characters in the parameter replaced with random digits between 0-9 inclusive. <p> For example, the string "ABC##EFG" could be replaced with a string like "ABC99EFG".
 * @param numberString
 * @return
 */
  ...
  /** 
 * Returns a string with the '?' characters in the parameter replaced with random alphabetic characters. <p> For example, the string "12??34" could be replaced with a string like "12AB34".
 * @param letterString
 * @return
 */
